...
export async function forwardInspectionRequestToAdmin(inspectionRequest) {
  ...
  const adminJobPayload = {
    ...
    payment: {
      ...
      totalAmount: inspectionRequest.payment?.amount || 0,
      paidAmount: inspectionRequest.payment?.paidAmount || 0,
      remainingAmount: inspectionRequest.payment?.remainingAmount || 0,
      amount: inspectionRequest.payment?.paidAmount || 0,
      currency: 'INR',
      razorpayOrderId: inspectionRequest.payment?.razorpayOrderId,
      razorpayPaymentId: inspectionRequest.payment?.razorpayPaymentId,
      paidAt: inspectionRequest.payment?.paidAt,
    },
